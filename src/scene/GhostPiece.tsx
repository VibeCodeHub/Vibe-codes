...
import { InstancedMesh, BoxGeometry, MeshStandardMaterial, Color, Object3D } from 'three';
...
export default function GhostPiece({ piece }: GhostPieceProps): React.ReactElement | null {
  ...
  useFrame(() => {
    ...
    (material as MeshStandardMaterial).color = GHOST_COLORS[colorId];
  ...
  return (
    <instancedMesh ref={instRef} args={[geometry, material, 4]} />
  );
}